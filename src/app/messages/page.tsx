  ...
  const createNewConversation = async () => {
    if (state.user !== null && state.loggedInUser !== null) {
      ...
      if (
        ...
        setSelectedConversation(convoDataJson[0].data.conversation_id);
      }
    }
        ...
        <div className="bg-[#F7F1EE]  overflow-auto my-auto h-[80vh] w-full md:w-10/12 sm:rounded-r-2xl lg:rounded-r-[6rem] z-20 relative">
          ...
          {!isCheckingConversation ? (
                ...
                <div className="flex h-[85%]">
                  <div
                    ...
                    <h2 className="tracking-[0.3rem] w-full text-center mx-auto flex py-4 border-b-2 border-inherit uppercase md:text-xl gap-2 md:gap-4 pl-[8%]">
                      <span className="m-auto w-fit font-sans font-bold">
                        Inbox
                      </span>
                    </h2>
                    <ul className="h-full">
                            ...
                            <Image
                              src={
                                convo.members[
                                  ...
                                  ? convo.members[
                                      convo.members[1].id == state.user?.id
                                        ? 2
                                        : 1
                                    ].profileImage
            ...
            w-full transition-all ease-in-out duration-200`}>
                ...
                <div className="flex h-[85%] flex-col items-center justify-center">
                  ...
                  <p className="text-center">
                    Start a conversation with a user by clicking on their
                    listing
                  </p>
                </div>
              )}
            ...
            <div
              ...
              <svg
                aria-hidden="true"
                className="m-auto w-[50px] h-[50px] text-gray-200 animate-spin dark:text-gray-600 fill-[#7F8119]"
                viewBox="0 0 100 101"
                fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path
