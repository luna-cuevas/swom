    ...
    <div className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-shadow w-full">
      ...
      <div className="p-3 sm:p-4">
        <Link href={listingUrl} className="block group">
          <h2 className="text-base sm:text-lg font-semibold mb-1 text-gray-900 line-clamp-1 group-hover:text-[#172544] transition-colors">
        ...
        <div className="mt-3 sm:mt-4 pt-3 border-t border-gray-100 flex items-center gap-2 sm:gap-3">
          <div className="relative w-7 h-7 sm:w-8 sm:h-8 rounded-full overflow-hidden flex-shrink-0 ring-2 ring-white">
            <Image
