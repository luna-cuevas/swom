...
export const HomeContent = ({ highlightedListings }: HomeContentProps) => {
  return (
    <>
        ...
        <div className="absolute w-fit h-fit m-auto inset-0 flex flex-col">
          ...
          <div className="flex-grow flex items-center justify-center px-4">
            <motion.div
              ...
              <h1 className="text-5xl sm:text-6xl md:text-7xl font-light tracking-wide drop-shadow-lg">
                MAKE MEMORIES
                <br />
                ALL OVER THE WORLD
              </h1>
              <p className="text-xl md:text-xl font-light max-w-2xl mx-auto text-white/90 drop-shadow">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-6 pt-4">
                <Link
                  href="/become-member"
                  className="px-12 py-4 bg-[#7F8119] hover:bg-[#8a8c25] transition-all duration-300 rounded-lg text-lg tracking-wide shadow-lg">
                  Join Now
                </Link>
                <Link
                  href="/how-it-works"
                  className="px-8 py-4 text-[#172544] bg-white/60 hover:bg-white/80 transition-all duration-300 rounded-lg text-lg tracking-wide backdrop-blur-sm shadow-lg">
                  How It Works
                </Link>
              </div>
            </motion.div>
      ...
      {/* Cities banner */}
      <div className="w-full py-8 bg-[#7F8119]/90 backdrop-blur-sm">
          ...
          <div className="flex flex-wrap justify-center items-center gap-x-12 gap-y-4">
            {[
              ...
              <motion.span
                ...
                className="text-white/90 text-lg tracking-[0.2em]">
                {city}
              </motion.span>
            ))}
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <motion.div
              ...
              className="space-y-8">
              <div>
                <h2 className="text-6xl font-light text-[#172544] mb-4">
                  SWOM
                </h2>
              ...
              <Link
                href="/listings"
                className="inline-block bg-[#172544] text-white px-10 py-4 rounded-lg text-lg transition-all duration-300 hover:bg-[#2a3b5e]">
                Explore Homes
              </Link>
            </motion.div>
            <motion.div
